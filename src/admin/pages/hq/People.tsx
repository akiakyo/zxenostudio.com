...
export function LeavePage(){
 ...
 return <div className="page"><PageHeader title="Leave" description="Request time off and track decisions. Members see their own requests; executives review the team."/>
...
export function WorkloadPage(){
 ...
 return <div className="page"><PageHeader title="Workload" description="Four-week capacity forecast. Plan around an 80% target; allocations above 100% need attention."/>
